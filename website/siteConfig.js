...
const users = [
  {
    caption: 'Solidity',
    image: '/img/TSolidity.svg',
    infoLink: 'https://solidity.readthedocs.io',
    pinned: true,
  },
];
...
const siteConfig = {
  ...
  projectName: 'Flake',
  organizationName: 'Flake Network',

  // For no header links in the top nav bar -> headerLinks: [],
  headerLinks: [
    {doc: 'about/about', label: 'About'},
    // {doc: 'working/working', label: 'Doc'},
    {doc: 'protocol/protocol', label: 'Protocol'},
